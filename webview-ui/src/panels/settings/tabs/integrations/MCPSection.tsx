/**
 * MCP Servers section of the Integrations tab.
 *
 * Contains the MCP server list, individual server cards, and the "Add MCP Server" form.
 */
...
import type { MCPServerConfig, MCPStatus } from '../../../../types/opencode';
