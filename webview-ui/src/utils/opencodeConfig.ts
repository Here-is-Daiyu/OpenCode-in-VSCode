...
export function getConfiguredModel(config?: OpenCodeConfig | null): string | undefined {
  return pickConfigString(config?.model);
}

export function getConfiguredAgent(config?: OpenCodeConfig | null): string | undefined {
