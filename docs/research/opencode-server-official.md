# OpenCode Server — Official Documentation

> **Source:** <https://opencode.ai/docs/server>
> **Archived:** 2026-03-14
> **Copyright:** © [Anomaly](https://anoma.ly). This document is a local archive of the official public documentation for development reference. All rights belong to the original authors.
...
> **Type references:** All linked types (`Session`, `Message`, `Part`, `Provider`, etc.) are defined in the [SDK generated types](https://github.com/anomalyco/opencode/blob/dev/packages/sdk/js/src/gen/types.gen.ts).
